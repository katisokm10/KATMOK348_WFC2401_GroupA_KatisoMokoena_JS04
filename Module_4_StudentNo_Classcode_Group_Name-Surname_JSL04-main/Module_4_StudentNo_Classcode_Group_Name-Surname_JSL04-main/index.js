...
console.log(`I want prefer a ${message} drink`);
...
let output = cansLeft < 5 ? "Time to restock!" : "We're stocked!"
console.log(`${output}`);
...
let cool = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!"
console.log(`${cool}`);
...
// If it's between 7am and midnight (24-hour format), print "Unleash the beast!"
// Otherwise, print "Better stick to water."
let DrinkMonster = currentHour >= 7 && currentHour < 24 ? "Unleash the beast!" : "Better stick to water."
